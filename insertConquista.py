...
tipos = ['Arma', 'Equipamento', 'Poder', 'Consumível',     "Primeiro Passo",
    "Mestre dos Combates",
...
def gerar_unidades(num_unidades):
    ...
    for _ in range(num_unidades):
        nome_item = random.choice(tipos) + " " + f'Conquista-{random.randint(1, 100)}'
...
unidades_geradas = gerar_unidades(500)
