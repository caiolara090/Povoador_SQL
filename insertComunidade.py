...
with open("insert_commands.txt", "w") as file:
    for i in range(106):  # Altere o valor 10 para o número desejado de comandos de inserção
        #codigo_jogo = random.choice(codigo_jogos)
        codigo_jogo = codigo_jogos[i]
        usuario = random.choice(usuarios)
        command = f"INSERT INTO `comunidade` VALUES ({codigo_jogo}, '{usuario}');\n"
        file.write(command)
